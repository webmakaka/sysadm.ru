...
permalink: /linux/servers/monitoring/check-mk/creating-and-managing-sites/
---
...
Предполагается что уже выполнены шаги по инсталляции  <a href="/linux/servers/monitoring/check-mk/install/">check_mk</a>.
