...
permalink: /linux/servers/containers/kubernetes/kubeadm/lets-encrypt/
---
...
![Kubernetes Lets Encrypt](/img/linux/servers/containers/kubernetes/kubeadm/lets-encrypt.png "Kubernetes Lets Encrypt"){: .center-image }
...
Подготавливаем Ingress Ingress Controller как <a href="/linux/servers/containers/kubernetes/kubeadm/ingress/nginxinc-kubernets-ingress-install/">здесь</a>.

<br/>

Устанавливаем haproxy как <a href="/linux/servers/containers/kubernetes/kubeadm/ingress/haproxy/">здесь</a>. 
...
Устанавливаем helm/tiller как <a href="/linux/servers/containers/kubernetes/kubeadm/heml/install/">здесь</a>. 
