...
permalink: /linux/servers/containers/docker/clustering/swarm/by-vagrant/
---
...
Делаю с помощью  <a href="/linux/servers/virtual/vagrant/">Vagrant</a>, т.к. при использовании docker-machine я не смог установить внутри виртуалок пакеты для поднятия NFS (Network file system).
