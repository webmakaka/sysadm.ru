...
permalink: /linux/servers/containers/docker/clustering/swarm/Native_Docker_Clustering/Securing_your_Swarm_Cluster/copy/
---
...
![Native Docker Clustering](/img/linux/servers/containers//docker/clustering/swarm/native-docker-clustering/pic3.png "Native Docker Clustering"){: .center-image }


<br/>

Подготовил с помощью следующего vagrant скрипта <a href="/linux/servers/virtual/vagrant/for-docker-swarm/"></a>следующее:
