...
permalink: /linux/devops/vcs/gitlab/install/ubuntu/
---
...
Сначала устанавливаем <a href="/linux/containers/docker/install/ubuntu/">docker</a>

<br/>

Потом поднимаем <a href="/linux/containers/docker/registry/">docker registry</a>. Возможен вариант без TLS и с TLS.
...
А также нужно будет добавить (т.к. в конфиге не нашел) ссылки на сертификаты. См. подробности по ссылке на установку <a href="/linux/containers/docker/registry/">registry</a>.
