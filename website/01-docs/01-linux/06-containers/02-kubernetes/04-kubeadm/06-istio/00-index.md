...
layout: page
title: Istio
permalink: /linux/containers/kubernetes/kubeadm/istio/
---
...
### [Устанавливаем Helm и Tiller](/linux/containers/kubernetes/kubeadm/heml/install/)

### [Устанавливаем MetalLB](/linux/containers/kubernetes/kubeadm/metal-load-balancer/)

### Подняли Dynamic NFS как<a href="/linux/containers/kubernetes/kubeadm/persistence/dynamic-nfs-provisioning/">здесь</a>
...
![Istio](/img/linux/containers/kubernetes/kubeadm/istio/pic-01.png "Istio"){: .center-image }
