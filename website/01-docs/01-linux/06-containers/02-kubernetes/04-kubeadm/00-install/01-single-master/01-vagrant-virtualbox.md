...
permalink: /linux/containers/kubernetes/kubeadm/install/single-master/vagrant-virtualbox/
---
...
Есть уже <a href="/linux/containers/kubernetes/kubeadm/prepared-cluster/">подготовленный вариант</a> развертывания kubernetes скриптами, где не нужно самому что-либо делать. Здесь информация, если хочется поднять самостоятельно.
