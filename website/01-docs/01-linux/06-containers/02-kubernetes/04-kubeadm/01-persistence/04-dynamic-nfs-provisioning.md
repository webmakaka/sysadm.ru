...
permalink: /linux/containers/kubernetes/kubeadm/persistence/dynamic-nfs-provisioning/
---
...
![kubernetes NFS provisioning](/img/linux/containers/kubernetes/kubeadm/persistence/NFS-provisioning.png "kubernetes NFS provisioning"){: .center-image }
...
Подготовили экспорт NFS как<a href="/linux/containers/kubernetes/kubeadm/persistence/nfs/">здесь</a>
