...
permalink: /linux/containers/coreos/introduction-to-coreos/deploying-a-database-backed-web-application/deploying-web-application/
---
...
![coreos cluster](/img/linux/containers/coreos/app6.png "coreos cluster"){: .center-image } 
