...
permalink: /linux/containers/coreos/introduction-to-coreos/deploying-a-database-backed-web-application/load-balancing-with-nginx-confd/
---
...
![coreos cluster](/img/linux/containers/coreos/app7.png "coreos cluster"){: .center-image } 
