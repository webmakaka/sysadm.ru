...
![etcd](/img/linux/containers/coreos/etcd.png "etcd"){: .center-image }
...
![fleetctl](/img/linux/containers/coreos/getting-started-with-coreos/pic3.png "fleetctl"){: .center-image }
