...
![coreos cluster example](/img/linux/containers/coreos/example/01/pic1.png "coreos cluster example"){: .center-image }
...
![coreos cluster example](/img/linux/containers/coreos/example/01/pic2.png "coreos cluster example"){: .center-image }
...
![coreos cluster example](/img/linux/containers/coreos/example/01/pic3.png "coreos cluster example"){: .center-image }
