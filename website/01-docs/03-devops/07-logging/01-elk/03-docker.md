...
Инсталлируем <a href="/devops/containers/docker/setup/ubuntu/">docker</a> и <a href="/devops/containers/docker/tools/docker-compose/install/ubuntu/">docker-compose</a>.
