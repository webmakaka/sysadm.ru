...
Предполагается что уже установлен <a href="/devops/linux/virtual/virtualbox/setup/">VirtualBox</a>, <a href="/devops/linux/virtual/vagrant/setup/ubuntu/">Vagrant</a>, <a href="/devops/containers/kubernetes/kubectl/setup/">kubectl</a>.
...
Если kubectl не установлена, то <a href="/devops/containers/kubernetes/kubectl/setup/">вот</a>.
