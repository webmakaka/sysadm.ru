...
permalink: /server/linux/virtual/kvm/
---
...
![Инсталляция KVM в CENTOS](/img/server/linux/virtual/kvm/remmina.png 'Инсталляция KVM в CENTOS'){: .center-image }

![Инсталляция KVM в CENTOS](/img/server/linux/virtual/kvm/kvm_01.png 'Инсталляция KVM в CENTOS'){: .center-image }

![Инсталляция KVM в CENTOS](/img/server/linux/virtual/kvm/kvm_02.png 'Инсталляция KVM в CENTOS'){: .center-image }

![Инсталляция KVM в CENTOS](/img/server/linux/virtual/kvm/kvm_03.png 'Инсталляция KVM в CENTOS'){: .center-image }
