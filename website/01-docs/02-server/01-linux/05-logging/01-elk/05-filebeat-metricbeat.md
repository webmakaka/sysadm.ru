...
permalink: /linux/server/linux/logging/elk/filebeat-metricbeat/
---
...
![FileBeat & MetricBeat](/img/server/linux/logging/elk/intall/filebeat-metricbeat-01.png 'FileBeat & MetricBeat'){: .center-image }

<br/>

### Поднимаю ELK в контейнере

Поднимаю ELK в контейнере как <a href="/linux/server/linux/logging/elk/docker/">здесь</a>. (Только на localhost)
...
![FileBeat & MetricBeat](/img/server/linux/logging/elk/intall/filebeat-metricbeat-02.png 'FileBeat & MetricBeat'){: .center-image }
...
![FileBeat & MetricBeat](/img/server/linux/logging/elk/intall/filebeat-metricbeat-03.png 'FileBeat & MetricBeat'){: .center-image }

<br/>

![FileBeat & MetricBeat](/img/server/linux/logging/elk/intall/filebeat-metricbeat-04.png 'FileBeat & MetricBeat'){: .center-image }
...
![FileBeat & MetricBeat](/img/server/linux/logging/elk/intall/filebeat-metricbeat-05.png 'FileBeat & MetricBeat'){: .center-image }

<br/>

![FileBeat & MetricBeat](/img/server/linux/logging/elk/intall/filebeat-metricbeat-06.png 'FileBeat & MetricBeat'){: .center-image }
